...
def check_routing(state: State) -> list[Send]:
    ...
    # Routing cho privacy_agent: kích hoạt khi câu hỏi liên quan dữ liệu/quyền riêng tư
    if any(kw in question_lower for kw in ["data", "privacy", "gdpr", "dữ liệu", "rò rỉ", "khách hàng"]):
...
Tập trung: GDPR, CCPA, bảo vệ dữ liệu, quyền riêng tư, rò rỉ dữ liệu (data breach),
nghĩa vụ thông báo vi phạm và mức phạt."""
...
def build_graph() -> StateGraph:
    ...
    # Add nodes (LƯU Ý: check_routing KHÔNG phải node — nó là hàm điều hướng,
    # trả về list[Send] để fan-out song song, nên gắn vào conditional edge bên dưới)
    ...
    # Sau law_agent, check_routing quyết định gọi (song song) những agent nào
